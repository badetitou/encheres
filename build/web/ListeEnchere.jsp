    ...
    <div class="container">
        ...
        <table class="highlight responsive-table centered">
            ...
            <tr>
                ...
                <td>
                    <a href="DetailArticle?refArticle=<%=a.getCode()%>"> <i class="material-icons">visibility</i></a>
                </td>
                <%
                    if(a.getEtatEnchere() == EtatEnchere.EN_COURS) {
                %>
                <td>
                    <a href="GestionEnchere?refArticle=<%=a.getCode()%>"> <i class="material-icons">gavel</i></a>
                </td>
                <%
                    }
                %>
